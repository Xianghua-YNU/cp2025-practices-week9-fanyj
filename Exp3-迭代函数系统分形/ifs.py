...
def get_tree_params():
    ...
    """
    return [
        [0.05, 0.00, 0.00, 0.60, 0.00, 0.00, 0.10],  # Trunk
        [0.05, 0.00, 0.00, 0.50, 0.00, 1.00, 0.10],  # Right branch
        [0.46, -0.15, 0.39, 0.38, 0.00, 0.60, 0.20], # Left leaves
        [0.47, 0.15, -0.39, 0.38, 0.00, 1.10, 0.20], # Right leaves
        [0.43, 0.28, 0.26, 0.45, 0.00, 1.00, 0.20],  # Right top
        [0.42, -0.28, 0.26, 0.45, 0.00, 0.70, 0.20]  # Left top
    ]
